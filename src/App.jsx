    ...
    <>
      <div className="my-20 max-w-lg mx-auto bg-white shadow p-10">
        ...
        <div className="flex justify-between my-6">
          <Button operador="-" fn={hanldeClickDecremento} />
          <Button operador="+" fn={handleClickAumentar} />
        </div>
        ...
        <select 
        className="mt-5 w-full p-2 bg-white border border-gray-300 rounded-lg text-center font-bold text-gray-500 text-xl"
        value={meses}
